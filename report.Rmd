...
Assuming the PSIS-LOO estimates to bee reliable, we can thus conclude that the hierarchical model should be preferred over the pooled one, since its ELPD-estimates are considerably higher.
